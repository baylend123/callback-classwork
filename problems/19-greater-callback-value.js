...
let greaterCallbackValue = function (number, callbackOne, callbackTwo) {
    if (callbackOne(number) > callbackTwo(number)) {
        return callbackOne(number)
    } else {
        return callbackTwo(number)
    }
